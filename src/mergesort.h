...
/*
    Arquivo .h relacionado ao merge sort, que utiliza tambem o quick sort quando o array for menor que um parametro 'i'
*/

typedef int (*comparador_merge)(const void* a, const void* b);

/// @brief Ordena um vetor usando o merge sort e utliza o quick sort para vetores pequenos
